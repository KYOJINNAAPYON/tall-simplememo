        ...
        <div class="p-3">
            <div class="overflow-x-auto">
                <table class="table-auto w-full">
                    ...
                    <td class="p-2 whitespace-nowrap text-center"><button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">編集</button></td>
                    <td class="p-2 whitespace-nowrap"><button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="confirm('本当に削除してもよろしいですか？') && 
                        Livewire.dispatch('delete-post',{ postId: {{$post->id}} })">削除</button></td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
